...
public enum ProminentMaterials implements ToolMaterial {
    ...
    private ProminentMaterials(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
